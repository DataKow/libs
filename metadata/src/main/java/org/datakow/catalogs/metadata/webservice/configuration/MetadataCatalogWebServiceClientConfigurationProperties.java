...
/**
 * Configuration Properties used for the web service clients.
 * <p>
 * Theses properties are mapped via Spring to the properties in the config server
 * @author kevin.off
 */
@ConfigurationProperties(prefix = "datakow.catalogs")
public class MetadataCatalogWebServiceClientConfigurationProperties {
    ...
    private int catalogRegistryCacheTimeInMinutes = 5;
